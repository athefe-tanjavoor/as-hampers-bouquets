...
import { BRAND_CONFIG, ORDER_STATUSES } from "@/lib/config";
...
export default function TrackOrderPage() {
  return (
    <Suspense fallback={<div className="bg-[#FFF9F5] min-h-screen py-16 text-center text-xs text-gray-500">Loading order tracker...</div>}>
      <TrackOrderContent />
    </Suspense>
  );
}
